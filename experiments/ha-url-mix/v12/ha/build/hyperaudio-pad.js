...
(function(global, document) {
  ...
  Popcorn.xhr.httpData = function( settings ) {
    ...
    console.log('Popcorn.xhr.httpData');
  ...
  Popcorn.xhr.getJSONP = function( url, success, isScript ) {
    ...
    console.log("Popcorn.xhr.getJSONP");
  ...
  Popcorn.getScript = Popcorn.xhr.getScript = function( url, success ) {
    ...
    console.log("Popcorn.xhr.getScript");
    console.log("url = "+url);
...
(function( Popcorn, window, document ) {
  ...
  function isYouTubeReady() {
    ...
    console.log("youtube ready = "+ytReady);
    return ytReady;
  }
  ...
  function HTMLYouTubeVideoElement( id ) {
    ...
    function changeSrc( aSrc ) {
      ...
      Popcorn.getJSONP( xhrURL, function( resp ) {
        ...
        console.log("create new YT.player");
...
var api = (function(hyperaudio) {
  ...
  return {
    ...
    getMixFromUrl: function (id, callback, force) {
      console.log("GET MIX FROM URL !!!!!!!!!!!!!!!!!!!!!!!!!!"); 
      var self = this;
      console.log(mixHTML);

      self.mix = {_id:"",content:mixHTML,created:"",desc:"",label:"Anything You Wants",modified:"", namespace:null, owner: "", tags:[], type: ""};

      console.log(self.mix);
    ...
    getMix: function(id, callback, force) {
      ...
      if(!force && this.mix && this.mix._id === id) {
        ...
        // Do not need to get username for an ID specific request.
        console.log("about to try and getUsername");
        console.log("premature self.mix");
        console.log(self.mix);
        this.getUsername(function(success) {
          if(success && id) {
            xhr({
...
var Player = (function(window, document, hyperaudio, Popcorn) {
  ...
  function Player(options) {
    ...
    this.options = hyperaudio.extend({}, this.options, {
      ...
      mediaType: {
        // Just a test MB DEBUG
        //mp4: 'video/mp4', // The mp4 mime type.
        mp4: 'application/vnd.apple.mpegurl',
  ...
  Player.prototype = {
    ...
    play: function(time) {
      if(this.youtube) {
        console.log("attempt to play youtube");
      ...
      if(this.stage && this.stage.target) {
        ...
        for(i = 0, len = this.content.length; i < len; i++) {
          if(this.content[i].element === sectionElem) {
            ...
            console.log("jumpTo:");
            console.dir(jumpTo);
            console.log("jumpTo.start : "+jumpTo.start);
